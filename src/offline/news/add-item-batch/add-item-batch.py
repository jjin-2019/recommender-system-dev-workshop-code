...
ps_item_file_name_list = ['personalize_item.csv']
ps_item_s3_folder = '{}/system/personalize-data/data'.format(prefix)
sync_s3(ps_item_file_name_list, ps_item_s3_folder, local_folder)

ps_config_file_name = ['ps_config.json']
ps_config_s3_folder = '{}/system/personalize-data/ps-config'.format(prefix)
...
def create_item_dataset_import_job():
    ...
    response = personalize.create_dataset_import_job(
        ...
        dataSource={
            'dataLocation': "s3://{}/{}/system/personalize-data/data/personalize_item.csv".format(bucket, prefix)
        },
